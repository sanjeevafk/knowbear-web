...
interface SearchBarProps {
    ...
    onModeChange: (mode: 'fast' | 'ensemble' | 'brief_dive') => void
}
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-2xl mx-auto space-y-6">
            ...
            <div className="flex flex-wrap justify-center gap-3">
                <button
                    ...
                    className={`px-4 py-2 rounded-full text-xs font-medium transition-all duration-300 border ${mode === 'fast'
                ...
                <button
                    type="button"
                    onClick={() => onModeChange('brief_dive')}
                    className={`px-4 py-2 rounded-full text-xs font-medium transition-all duration-300 border ${mode === 'brief_dive'
                        ? 'bg-purple-500/10 text-purple-400 border-purple-500 shadow-[0_0_10px_rgba(168,85,247,0.3)]'
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-full text-xs font-medium transition-all duration-300 border ${mode === 'ensemble'
                        ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.3)]'
